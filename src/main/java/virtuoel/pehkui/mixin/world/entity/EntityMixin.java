...
public abstract class EntityMixin {
	...
	@ModifyArg(method = "checkFallDamage", index = 4, at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/block/Block;fallOn(Lnet/minecraft/world/level/Level;Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/entity/Entity;F)V"))
	...
	@ModifyConstant(method = "checkSlowFallDistance", constant = @Constant(floatValue = 1.0F))
	private float pehkui$checkSlowFallDistance(float constant) {

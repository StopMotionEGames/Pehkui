...
public abstract class AbstractBoatMixin
{
	...
	private AABB pehkui$tick$inflate(AABB obj, double x, double y, double z, Operation<AABB> original)
	{
		Entity boat = (Entity) (Object) this;
		final float widthScale = ScaleUtils.getBoundingBoxWidthScale(boat);
		final float heightScale = ScaleUtils.getBoundingBoxHeightScale(boat);
	...
	private double pehkui$checkInWater$offset(double value)
	{
	...
	private double pehkui$isUnderwater$offset(double value)
	{
		final Entity self = (Entity) (Object) this;
		final float scale = ScaleUtils.getBoundingBoxHeightScale(self);
